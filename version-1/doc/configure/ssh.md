...
```
добавлять именно в /var/www надо потому, что у пользователя www-data, эта папка является домашней, а в нашем конфиге поиск этого файла определен иммено там
```
